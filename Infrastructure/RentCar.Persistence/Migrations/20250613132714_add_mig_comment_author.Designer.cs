...
{
    [DbContext(typeof(RentCarCaontext))]
    [Migration("20250613132714_add_mig_comment_author")]
    partial class add_mig_comment_author
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentCar.Domain.Entities.Car", b =>
                {
                    ...
                    b.HasOne("RentCar.Domain.Entities.Feature", null)
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("RentCar.Domain.Entities.Comment", b =>
                {
                    b.HasOne("RentCar.Domain.Entities.Author", "Authors")
                        .WithMany("Comments")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
